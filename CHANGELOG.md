...
- **CI test failures** — `runShellCommand` now ensures the default workspace
  directory exists before spawning; tests no longer depend on the gitignored
  `.test-data/` directory being present.
